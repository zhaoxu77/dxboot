 ...
 * @projectName：FCS
 * @packageName： com.dixn.redis
 * @ClassName：RedisUtil
 * @author：zhaoxu
 * @createTime：2018/8/30 10:46
 * @upate：zhaoxu
 * @updateDate：2018/8/30 10:46
 * @remark：
 * @version v1.0
 */
@Component
public class RedisUtil {
     ...
     * @author：zhaoxu
     * @createTime：2018/8/30-10:58
     * @updateUser：zhaoxu
     * @UpdateTime：2018/8/30-10:58
     * @UpdateRemark：
     * @throws 
     * @return：
     * @version：1.0
     ...
     * @return 移除的个数
     */
    public List<String> getKeys(String macthKey){
        List<String> result = null;
        try{
            Set<String> temp_set = redisTemplate.keys(macthKey);
            if(temp_set != null && !temp_set.isEmpty()){
